...
// Push elements from stack_a to stack_b until only three elements remain in stack_a.
// This uses rotation logic to find the optimal elements to move.
...
void sort_big(t_stack **a)
{
    ...
    b = sort_b(a);     // Push elements from A to B.
    a = push_back_to_a(a, &b);       // Push elements back from B to A.
